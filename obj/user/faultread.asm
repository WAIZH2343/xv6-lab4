	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001fb:	0f be 80 88 10 80 00 	movsbl 0x801088(%eax),%eax
  800202:	50                   	push   %eax
...
00800252 <vprintfmt>:
{
  ...
  8002a2:	3e ff 24 85 40 11 80 	notrack jmp *0x801140(,%eax,4)
  8002a9:	00 
  ...
  80036f:	8b 14 85 a0 12 80 00 	mov    0x8012a0(,%eax,4),%edx
  800376:	85 d2                	test   %edx,%edx
  800378:	74 18                	je     800392 <vprintfmt+0x140>
				printfmt(putch, putdat, "%s", p);
  80037a:	52                   	push   %edx
  80037b:	68 a9 10 80 00       	push   $0x8010a9
  800380:	53                   	push   %ebx
  800381:	56                   	push   %esi
  ...
  800392:	50                   	push   %eax
  800393:	68 a0 10 80 00       	push   $0x8010a0
  800398:	53                   	push   %ebx
  800399:	56                   	push   %esi
  ...
  8003ba:	b8 99 10 80 00       	mov    $0x801099,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b83:	68 c4 12 80 00       	push   $0x8012c4
  800b88:	6a 23                	push   $0x23
  800b8a:	68 e1 12 80 00       	push   $0x8012e1
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c10:	68 c4 12 80 00       	push   $0x8012c4
  800c15:	6a 23                	push   $0x23
  800c17:	68 e1 12 80 00       	push   $0x8012e1
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c56:	68 c4 12 80 00       	push   $0x8012c4
  800c5b:	6a 23                	push   $0x23
  800c5d:	68 e1 12 80 00       	push   $0x8012e1
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c9c:	68 c4 12 80 00       	push   $0x8012c4
  800ca1:	6a 23                	push   $0x23
  800ca3:	68 e1 12 80 00       	push   $0x8012e1
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800ce2:	68 c4 12 80 00       	push   $0x8012c4
  800ce7:	6a 23                	push   $0x23
  800ce9:	68 e1 12 80 00       	push   $0x8012e1
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d28:	68 c4 12 80 00       	push   $0x8012c4
  800d2d:	6a 23                	push   $0x23
  800d2f:	68 e1 12 80 00       	push   $0x8012e1
...
sys_ipc_recv(void *dstva)
{
  ...
  800d94:	68 c4 12 80 00       	push   $0x8012c4
  800d99:	6a 23                	push   $0x23
  800d9b:	68 e1 12 80 00       	push   $0x8012e1
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800dc5:	56                   	push   %esi
  800dc6:	50                   	push   %eax
  800dc7:	68 f0 12 80 00       	push   $0x8012f0
  ...
  800dd8:	e8 1d f3 ff ff       	call   8000fa <vcprintf>
	cprintf("\n");
  800ddd:	c7 04 24 7c 10 80 00 	movl   $0x80107c,(%esp)
