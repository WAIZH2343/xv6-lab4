...
sys_env_destroy(envid_t envid)
{
  ...
  800127:	68 6f 10 80 00       	push   $0x80106f
  80012c:	6a 23                	push   $0x23
  80012e:	68 8c 10 80 00       	push   $0x80108c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001b4:	68 6f 10 80 00       	push   $0x80106f
  8001b9:	6a 23                	push   $0x23
  8001bb:	68 8c 10 80 00       	push   $0x80108c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001fa:	68 6f 10 80 00       	push   $0x80106f
  8001ff:	6a 23                	push   $0x23
  800201:	68 8c 10 80 00       	push   $0x80108c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800240:	68 6f 10 80 00       	push   $0x80106f
  800245:	6a 23                	push   $0x23
  800247:	68 8c 10 80 00       	push   $0x80108c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800286:	68 6f 10 80 00       	push   $0x80106f
  80028b:	6a 23                	push   $0x23
  80028d:	68 8c 10 80 00       	push   $0x80108c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002cc:	68 6f 10 80 00       	push   $0x80106f
  8002d1:	6a 23                	push   $0x23
  8002d3:	68 8c 10 80 00       	push   $0x80108c
...
sys_ipc_recv(void *dstva)
{
  ...
  800338:	68 6f 10 80 00       	push   $0x80106f
  80033d:	6a 23                	push   $0x23
  80033f:	68 8c 10 80 00       	push   $0x80108c
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800369:	56                   	push   %esi
  80036a:	50                   	push   %eax
  80036b:	68 9c 10 80 00       	push   $0x80109c
  ...
  80037c:	e8 5a 00 00 00       	call   8003db <vcprintf>
	cprintf("\n");
  800381:	c7 04 24 bf 10 80 00 	movl   $0x8010bf,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8004dc:	0f be 80 c1 10 80 00 	movsbl 0x8010c1(%eax),%eax
  8004e3:	50                   	push   %eax
...
00800533 <vprintfmt>:
{
  ...
  80065b:	52                   	push   %edx
  80065c:	68 e2 10 80 00       	push   $0x8010e2
  800661:	53                   	push   %ebx
  800662:	56                   	push   %esi
  ...
  800673:	50                   	push   %eax
  800674:	68 d9 10 80 00       	push   $0x8010d9
  800679:	53                   	push   %ebx
  80067a:	56                   	push   %esi
  ...
  80069b:	b8 d2 10 80 00       	mov    $0x8010d2,%eax
